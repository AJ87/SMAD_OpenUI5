sap.ui.jsfragment("SMADJS.view.PrivacyFragment", {
	createContent: function(oController) {
		...
		var oText1 = new sap.m.Text({
			text:"I give permission for SMAD Camp to use my child/ren’s voice, testimonial, and picture (without name) in any type of memorabilia and/or promotional material (social media, church website, newsletters, bulletins and brochures) about SMAD Camp."
		});
