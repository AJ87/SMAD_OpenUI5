...
const fields =
  ...
  const childFields =
    ['id','firstName','lastName','preferredName','birthdate','gender','school','year','shirt',
  ...
  const childHeading = '"ID","First Name","Last Name","Preferred Name","Birthdate","Gender","School","Year","Shirt Size",' +
